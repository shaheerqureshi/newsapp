...
export class News extends Component {
  ...
  async componentDidMount(){
    let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=cf14b702fcc54cebad78c578c6dc8209";
  ...
  handlePrevClick = async () =>{
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=cf14b702fcc54cebad78c578c6dc8209&page=${this.state.page - 1}&pageSize=20`;
    let data = await fetch(url);
    let parsedData = await data.json();
    this.setState({
